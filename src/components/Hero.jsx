...
const HeroSection = () => {
  return (
    <div className="relative w-full min-h-screen bg-[#9d86e1] overflow-hidden">
      {/* Container to enforce consistent layout */}
      <div className="container mx-auto h-full relative px-4">
        ...
        <motion.div
          ...
          className="absolute top-0 right-[-15%] md:right-[-10%] lg:right-[-5%] h-full w-[100%] md:w-[60%] max-w-full overflow-hidden z-0"
        >
          <img
            src={heroImage}
            alt="Hero background"
        ...
        {/* Hero Content with fixed positioning */}
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.4 }}
          className="relative pt-[33vh] md:pt-[30vh] max-w-[90%] md:max-w-[45%] z-20"
        >
          <div className="relative">
            <h1 className="text-white font-campton text-4xl sm:text-5xl md:text-7xl italic font-extrabold uppercase leading-tight tracking-wide mb-6">
              ...
              revolutionize teenage health
            </h1>
          </div>
          
          <p className="text-white text-lg sm:text-xl font-bold font-baton-turbo mb-8 pl-1">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#9d86e1] via-[#9d86e1] to-transparent opacity-10 z-10" />
    </div>
  );
};
